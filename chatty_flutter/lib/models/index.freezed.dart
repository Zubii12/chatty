...
/// @nodoc
class _$RegisterCopyWithImpl<$Res> extends _$RouterStateCopyWithImpl<$Res>
...
class _$Register extends Register {
  const _$Register() : super._();

  @override
  String toString() {
    return 'RouterState.register()';
  }
...
class _$StateModelTearOff {
  ...
  Fulfilled<T> fulfilled<T>({required T data}) {
    return Fulfilled<T>(
      data: data,
    );
  }
...
mixin _$StateModel<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(T data) fulfilled,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(T data)? fulfilled,
  ...
  TResult map<TResult extends Object?>({
    ...
    required TResult Function(Fulfilled<T> value) fulfilled,
  ...
  TResult? mapOrNull<TResult extends Object?>({
    ...
    TResult Function(Fulfilled<T> value)? fulfilled,
...
/// @nodoc
abstract class $FulfilledCopyWith<T, $Res> {
  factory $FulfilledCopyWith(
          Fulfilled<T> value, $Res Function(Fulfilled<T>) then) =
      _$FulfilledCopyWithImpl<T, $Res>;
  $Res call({T data});
}

/// @nodoc
class _$FulfilledCopyWithImpl<T, $Res> extends _$StateModelCopyWithImpl<T, $Res>
    implements $FulfilledCopyWith<T, $Res> {
  _$FulfilledCopyWithImpl(
      Fulfilled<T> _value, $Res Function(Fulfilled<T>) _then)
      : super(_value, (v) => _then(v as Fulfilled<T>));

  @override
  Fulfilled<T> get _value => super._value as Fulfilled<T>;

  @override
  $Res call({
    Object? data = freezed,
  }) {
    return _then(Fulfilled<T>(
      data: data == freezed
          ? _value.data
...
class _$Fulfilled<T> implements Fulfilled<T> {
  const _$Fulfilled({required this.data});
  ...
  @override
  String toString() {
    return 'StateModel<$T>.fulfilled(data: $data)';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is Fulfilled<T> &&
  ...
  @JsonKey(ignore: true)
  @override
  $FulfilledCopyWith<T, Fulfilled<T>> get copyWith =>
      _$FulfilledCopyWithImpl<T, Fulfilled<T>>(this, _$identity);
...
abstract class Fulfilled<T> implements StateModel<T> {
  const factory Fulfilled({required T data}) = _$Fulfilled<T>;
...
/// @nodoc
class _$ErrorCopyWithImpl<T, $Res> extends _$StateModelCopyWithImpl<T, $Res>
...
class _$Error<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'StateModel<$T>.error(message: $message)';
  }
...
abstract class Error<T> implements StateModel<T> {
